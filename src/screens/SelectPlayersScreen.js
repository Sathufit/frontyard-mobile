      ...
      <SafeAreaView style={styles.container} edges={['bottom']}>
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <TouchableOpacity style={styles.nextButton} onPress={handleNextStep} disabled={loading}>
            {loading ? <ActivityIndicator color={colors.background} /> : <Text style={styles.nextButtonText}>Start Match</Text>}
          </TouchableOpacity>
        </ScrollView>
      </SafeAreaView>
    );
...
const styles = StyleSheet.create({
  ...
  header: { padding: 20, paddingBottom: 8, borderBottomWidth: 1, borderBottomColor: colors.border },
  heading: { color: colors.textPrimary, fontSize: 20, fontWeight: 'bold' },
  subheading: { color: colors.textMuted, fontSize: 13, marginTop: 2 },
  content: { padding: 20, gap: 6 },
  section: { marginBottom: 12 },
  label: { color: colors.textSecondary, fontSize: 11, fontWeight: '700', letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 8, marginTop: 4 },
  selectedRow: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: 'rgba(200,255,58,0.08)',
    borderRadius: 8, padding: 10, marginBottom: 4,
    borderWidth: 1, borderColor: 'rgba(200,255,58,0.2)',
  },
  orderNum: { color: colors.accent, fontWeight: 'bold', width: 24, fontSize: 14 },
  playerNameSelected: { flex: 1, color: colors.textPrimary, fontSize: 14 },
  moveButtons: { flexDirection: 'row', gap: 4, marginRight: 8 },
  moveBtn: { paddingHorizontal: 8, paddingVertical: 4, backgroundColor: colors.surfaceElevated, borderRadius: 4 },
  ...
  playerRowSelected: { borderColor: colors.accent, backgroundColor: 'rgba(200,255,58,0.05)' },
  ...
  checkmark: { color: colors.accent, fontWeight: 'bold', fontSize: 16 },
  ...
  addBtn: { backgroundColor: colors.surfaceElevated, borderColor: colors.border, borderWidth: 1, borderRadius: 10, paddingHorizontal: 16, justifyContent: 'center' },
  addBtnText: { color: colors.textPrimary, fontWeight: '600' },
  nextButton: { backgroundColor: colors.accent, borderRadius: 12, paddingVertical: 17, alignItems: 'center', marginTop: 16 },
  nextButtonText: { color: colors.background, fontWeight: 'bold', fontSize: 16 },
  toggleRow: { flexDirection: 'row', gap: 10, marginBottom: 8 },
  toggleBtn: { flex: 1, paddingVertical: 13, alignItems: 'center', borderRadius: 10, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surfaceElevated },
  ...
  tossSummary: { color: colors.accent, textAlign: 'center', fontSize: 15, fontWeight: '600', marginVertical: 16 },
});
